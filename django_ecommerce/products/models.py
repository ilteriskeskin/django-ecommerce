...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("category-detail", kwargs={"slug": str(self.slug)})
...
class Product(models.Model):
    ...
    price = models.DecimalField(
        max_digits=7, decimal_places=2, verbose_name="Product Price"
    )
    ...
    def get_absolute_url(self):
        return reverse(
            "product-detail",
            kwargs={"category_slug": str(self.category.slug), "slug": str(self.slug)},
        )
